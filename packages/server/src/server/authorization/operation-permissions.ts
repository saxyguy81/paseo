...
const INBOUND_PERMISSION = {
  ...
  "diagnostics.incident.report.request": "daemon.read",
  ...
  "push.web.subscribe.request": "access.manage",
  "push.web.unsubscribe.request": "access.manage",
...
const OUTBOUND_PERMISSION = {
  ...
  "diagnostics.incident.report.response": "daemon.read",
  ...
  "push.web.subscribe.response": "access.manage",
  "push.web.unsubscribe.response": "access.manage",
